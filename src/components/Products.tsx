  ...
  const products = [
    {
      ...
      image: '/assets/Early-Childhood-Parenting-Made-Simple.jpeg',
    ...
    },
    {
      ...
      author: 'By Teena Benjamin',
      image: '/assets/mentors_manual.jpeg',
    ...
    },
    {
      ...
      author: 'By Teena Benjamin',
      image: '/assets/preschool-homework-book.jpeg',
    ...
    },
    {
      ...
      author: 'By Teena Benjamin',
      image: '/assets/pre-school-mentors-textbook.jpeg',
    ...
    },
    {
      ...
      author: 'By Teena Benjamin',
      image: '/assets/book-of-stories-and-rhymes.jpeg',
    ...
    },
    {
      ...
      author: 'By Teena Benjamin',
      image: '/assets/freedom-to-choose-motherhood.jpeg',
    ...
    },
    {
      ...
      image: '/assets/preschool-bundle.jpg',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {products.map((product, index) => (
            ...
            >
              <div className="relative rounded-xl mb-4 overflow-hidden aspect-[4/5]">
                <img 
                  src={product.image} 
                  alt={product.title} 
              ...
              <button 
                className="w-full flex items-center justify-center gap-2 bg-[#FFD600]/10 hover:bg-[#FFD600]/20 text-[#FFD600] py-3 rounded-lg transition-all cursor-pointer"
                onClick={() => {
                  const message = encodeURIComponent(`Hi, I'd like to purchase "${product.title}"`);
                  window.location.href = `https://wa.me/+918891337811?text=${message}`;
                }}
              >
                <span>Buy Now</span>
